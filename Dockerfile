FROM wumvi/php.fpm.prod
MAINTAINER Vitaliy Kozlenko <vk@wumvi.com>

LABEL version="1.0" php="7.2" mode="dev"
...
RUN DEBIAN_FRONTEND=noninteractive && \
    ...
    apt-get install --no-install-recommends -qq -y php7.2-xdebug php7.2-dev && \
	mkdir -p /soft/ && \
	#
	cd /soft/ && \
	...
	#
	apt-get -y remove build-essential cmake php7.2-dev && \
